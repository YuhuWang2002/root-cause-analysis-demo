...
export function Button({
  ...
  const variants = {
    primary: 'bg-primary text-white hover:bg-primary-dark focus:ring-primary active:translate-y-px',
    secondary: 'border-2 border-primary text-primary bg-transparent hover:bg-primary/5 focus:ring-primary',
    danger: 'bg-error text-white hover:bg-red-700 focus:ring-error active:translate-y-px',
